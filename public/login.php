        ...
        <div class="card-action clearfix">
          <div class="row">
            <div class="col s12 right-align text-p">
              <a href="registro.php" class="orange-text tooltipped" data-position="top" data-delay="50" data-tooltip="Registrate ahora">REGÍSTRATE AHORA</a><a class="modal-trigger orange-text tooltipped" data-position="top" data-delay="50" href="#modal11" data-tooltip="recuperar contraseña" >Recuperar contraseña</a>
            </div>
          </div>
        </div>
      </div>
