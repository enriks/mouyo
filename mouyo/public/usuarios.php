...
<ul id='menu' class='center'>
	<div class='row'>
		...
		<li data-menuanchor='firstPage' class='active'><a href='#<?php print $dat['nombre'] ?>'> Mi perfil :D </a>	</li>
	</div>
</ul>
<form method="post" name="nada" class="row" enctype="multipart/form-data">
