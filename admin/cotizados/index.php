...
$sql="SELECT usuario.id_usuario,cotizacion.pedido,cotizacion.id_cotizacion,cotizacion.nombre nombre_cotizacion,usuario.alias nombre_usuario,cotizacion.fecha from usuario,cotizacion where cotizacion.id_usuario = usuario.id_usuario and cotizacion.pedido=? order by cotizacion.id_usuario";
